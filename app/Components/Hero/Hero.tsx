...
const Hero = () => {
  return (
    <section className="min-h-screen w-full flex items-center justify-center p-4 md:p-10 hero">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-8 md:ml-10">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center md:items-start">
          ...
          <button className="absolute font-cta bottom-12 md:bottom-[200px] px-8 py-3 bg-amber-500/90 hover:bg-amber-500 text-stone-900 rounded-lg transition-colors flex items-center gap-2 mx-auto">
